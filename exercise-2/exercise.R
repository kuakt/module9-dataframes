...
salaries$salaries.2015[57] # or salaries[57, "salaries.2015"]
...
salaries$employees[salaries$raise == highest.raise]
# or:
salaries[salaries$raise == highest.raise, "employees"]

# What was the largest decrease in salaries between the two years?
largest.decrease <- min(salaries$raise)

# What was the name of the employee who recieved largest decrease in salary?
salaries[salaries$raise == largest.decrease, "employees"]
